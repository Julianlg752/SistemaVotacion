...
<body>
<form method="POST" action="edil.php">

<?php
session_start();
include("conexion.php");
	$selec_fotos="SELECT * FROM ASPIRANTES asp  WHERE CATEGORIA='EDIL'";
...
<label class="elegir">ELIJA UN EDIL</label>
<?php 
...
where va.idvotante=$idVotante and categoria='edil'";
...
echo "<script >alert('ya voto por un edil no puede volver a realizar una votacion') </script>";
}
